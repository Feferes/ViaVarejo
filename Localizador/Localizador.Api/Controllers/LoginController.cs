...
namespace Localizador.Api.Controllers
{
    ...
    public class LoginController : ControllerBase
    {
        public object Post(
            ...
            [FromServices]IRepository<User> usersDAO,
            ...
            [FromServices]TokenConfigurations tokenConfigurations)
        {
            ...
            {
                var usuarioBase = usersDAO.Select(usuario.Id);

                credenciaisValidas = (usuarioBase != null && usuario.Id == usuarioBase.Id && usuario.Accesskey == usuarioBase.Accesskey);
            }
